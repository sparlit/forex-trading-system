...
async def test():
    ...
    print('Prices attr:', app.market_data)
    # Check if watcher fires
    app.market_data = {'TEST': {'bid': 1.0, 'ask': 1.0, 'change': 0.1, 'change_pct': 1.0, 'time': 'now', 'timeframe': 'TICK'}}
    print('After setting market_data')
